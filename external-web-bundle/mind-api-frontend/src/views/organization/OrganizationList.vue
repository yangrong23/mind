...
/* 与知识库列表卡片统一尺寸：160px 高、18px 20px 内边距、16px 圆角 */
.org-card {
  ...
  &::before {
    ...
    width: 120px;
    height: 80px;
    background: radial-gradient(ellipse 60% 50% at 100% 0%, rgba(14, 165, 233, 0.06) 0%, transparent 70%);
    pointer-events: none;
    z-index: 0;
  }
  ...
  &:hover {
    border-color: rgba(14, 165, 233, 0.5);
    box-shadow: 0 10px 28px -10px rgba(14, 165, 233, 0.18);
    transform: translateY(-2px);
  }
