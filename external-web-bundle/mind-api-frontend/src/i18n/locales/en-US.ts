export default {
  ...
  insights: {
    ...
    wordCount: '{count} words · {refs} citations',
    noSources: 'No content found for this time range. Try expanding the range or adding knowledge bases.',
    errorRetry: 'Retry',
    loadFailed: 'Failed to load, please try again',
  },
  notes: {
    title: 'Notes',
    subtitle: 'Your second brain — capture, organize, revisit',
    create: 'New Note',
    untitled: 'Untitled',
    ...
    loadContentFailed: 'Failed to load note content',
    createFailed: 'Failed to create note',
    renameFailed: 'Rename failed',
    placeholder: {
      title: 'Pick a note to start reading',
      hint: 'Or create a new one from the top right.',
    },
    editor: {
    ...
    empty: {
      title: 'No notes yet',
      hint: 'Click "New Note" to start your first one.',
    },
    delete: {
      title: 'Delete Note',
  ...
  recordings: {
    title: 'Recordings',
    subtitle: 'Capture ideas and meetings — AI transcribes them into notes',
    create: 'Upload',
    listEmpty: 'No recordings yet',
    listEmptyHint: 'Tap upload at the top to add your first audio.',
    uploadHint: 'Supports mp3 / m4a / wav, up to 50MB per file',
  ...
  landing: {
    eyebrow: 'Mind · Your AI Knowledge Workspace',
    headline: 'Turn scattered information into an extension of your thought',
    subheadline: 'Voice capture · Knowledge graph · Agent collaboration — research, notes, and conversations in one place.',
    ctaPrimary: 'Get Started',
    ctaSecondary: 'Learn More',
    features: {
      voiceTitle: 'Voice Capture',
      voiceDesc: 'Record ideas anytime, automatically transcribed and filed into your knowledge base.',
      graphTitle: 'Knowledge Graph',
      graphDesc: 'Concepts auto-link to surface hidden relationships in your thinking.',
      agentTitle: 'Agent Collaboration',
      agentDesc: 'Let AI search, draft, and reason — get work done conversationally.',
      multiTitle: 'Sync Everywhere',
      multiDesc: 'Desktop and Web stay in sync — never lose context across screens.',
    },
    footer: '© 2026 Mind. All rights reserved.',
    // Navigation
    navProduct: 'Product',
    ...
    signIn: 'Sign in',
    // Hero
    headlineLine2: 'wisdom grows with your library',
    heroMockTitle: 'My Library',
    heroSidebar0: 'Home',
    heroSidebar1: 'Favorites',
    heroSidebar2: 'Recent',
    heroSidebar3: 'My Library',
    heroSidebar4: 'Projects',
    socialProof: 'Join knowledge workers who think smarter with Mind',
    // Capture section
    captureTitle: 'Capture knowledge fragments effortlessly',
    captureSubtitle: 'Import from the web, files, and mobile — or subscribe to curated libraries. Content is parsed deeply so you can start fast.',
    captureFeature0Title: 'Web clipping',
    captureFeature0Desc: 'Save pages and articles to your library in one click.',
    captureFeature1Title: 'File upload & parsing',
    captureFeature1Desc: 'PDF, Word, PPT, Excel, and more — interpreted for search and Q&A.',
    captureFeature2Title: 'Capture on any device',
    captureFeature2Desc: 'Notes, voice, and photos on phone or web — same account, same library.',
    captureTableTitle: 'My knowledge base',
    captureCol0: 'Title',
    captureCol1: 'Source',
    captureCol2: 'Type',
    captureCol3: 'Added',
    captureRow0_0: 'Product weekly.pdf',
    captureRow0_1: 'Upload',
    captureRow0_2: 'PDF',
    captureRow0_3: 'May 12',
    captureRow1_0: 'Industry library',
    captureRow1_1: 'Plaza',
    captureRow1_2: 'Library',
    captureRow1_3: 'May 10',
    captureRow2_0: 'Meeting recording',
    captureRow2_1: 'Mobile',
    captureRow2_2: 'Audio',
    captureRow2_3: 'May 9',
    // Q&A section
    qaTitle: 'Precise Q&A from your knowledge base — Mind delivers results',
    qaSubtitle: 'Answers are grounded in sources you trust, with citations back to the original text.',
    qaBullet0: 'Understands your question in context',
    qaBullet1: 'Cited sources — reliable and traceable',
    qaBullet2: 'Multi-turn dialogue and complex tasks',
    qaQuestion: 'Who are our core target users?',
    qaAnswer: 'Based on user research and interview notes in your library, core segments include:',
    qaPoint0: 'Knowledge workers who manage many documents',
    qaPoint1: 'Teams that need one shared source of truth',
    qaPoint2: 'Learners building personal knowledge systems',
    qaCite0: 'User research report.pdf',
    qaCite1: 'Interview notes',
    // Notes section
    notesTitle: 'AI notes — a creative partner that gets you',
    notesSubtitle: 'Full AI-assisted writing: capture ideas, polish expression, and move finished notes into your library.',
    notesDocTitle: 'Product requirements',
    notesDocBody: 'This release focuses on library-grounded Q&A and the content factory. Mobile and web should share the same library and Mind experience…',
    notesMenu0: 'Continue writing',
    notesMenu1: 'Polish',
    notesMenu2: 'Summarize',
    notesMenu3: 'Translate',
    notesFeature0Title: 'Smart completion',
    notesFeature0Desc: 'Continue and complete from context in your notes.',
    notesFeature1Title: 'Format & clarity',
    notesFeature1Desc: 'Improve structure and readability in one step.',
    notesFeature2Title: 'Translate & polish',
    notesFeature2Desc: 'Multilingual drafts with tone you control.',
    // Collaboration section
    collabSharedTitle: 'Our shared brain',
    collabBullet0: 'Real-time collaboration — everyone stays on the same page',
    collabBullet1: 'Comments and discussions that improve the knowledge',
    collabBullet2: 'Version history so important changes are traceable',
    collabDocTitle: 'Q2 product plan',
    collabDocSnippet: 'Consensus this week: prioritize library Q&A and the content factory; Mind and Studio share the same sources…',
    collabComment: '@team Updated research summary in the library.',
    collabPermissionsTitle: 'Flexible permissions',
    permPrivateTitle: 'Private',
    permPrivateDesc: 'Personal — only you',
    permTeamTitle: 'Team',
    permTeamDesc: 'Shared with your group',
    permPublicTitle: 'Public',
    permPublicDesc: 'Publish or subscribe on the plaza',
    // Resources section
    resourcesTitle: 'Access massive professional knowledge — ready to use',
    resourcesSubtitle: 'Subscribe on the library plaza — no need to build from zero on day one.',
    resource0Stat: '1,000+',
    resource0Label: 'Library templates',
    resource1Stat: '5,000+',
    resource1Label: 'Industry reports',
    resource2Stat: '10,000+',
    resource2Label: 'Study materials',
    resource3Stat: '3,000+',
    resource3Label: 'Case studies',
    resource4Stat: '2,000+',
    resource4Label: 'Dev docs',
    resource5Stat: 'Millions',
    resource5Label: 'Community',
    // Footer CTA
    footerCtaTitle: 'Start your knowledge journey in the browser',
    footerCtaSubtitle: 'Open the web app — capture, organize, and ask Mind with the same library on desktop.',
    footerCtaBtn: 'Try web app now',
    footerCopyright: '© Mind. All rights reserved.',
    footerLink0: 'About',
    footerLink1: 'Terms',
    footerLink2: 'Help',
    footerLink3: 'Contact',
  ...
  mindarAuth: {
    joinTitle: 'Join Mindar',
    joinSubtitle:
      'Sign in to sync notes, knowledge libraries, and your Mind Copilot across the web.',
    ...
    signInSubtitle: 'Enter your password for',
    back: 'Back',
    home: 'Home',
    backToApp: 'Back to app',
    illustrationTitle: 'Mind Copilot,',
    illustrationTitle2: 'wisdom grows with your library',
    illustrationTagline:
      'Capture, organize, digest, share, and deliver — so every piece of knowledge creates value.',
    hasAccount: 'Already have an account?',
    noAccount: 'New to Mindar?',
    signInWithEmail: 'Sign in with email',
    createAccount: 'Create account',
    socialDemo: '{provider} sign-in requires OIDC configuration on the server.',
    googleOidcUnavailable:
      'Google sign-in is not enabled on this server. Ask your admin to configure OIDC, or use email.',
  },
  authStore: {
    errors: {
  ...
  knowledgeList: {
    ...
    processingImport: 'Processing import task',
...
\
  ...
  workspace: {
    ...
    noInviteCode: 'No invite code generated yet',
    ...
    confirmLeave: 'Confirm leave workspace',
  ...
  error: {
    ...
    model: {
      ...
      syncFailed: 'Failed to sync from Bifrost'
    },
    tenant: {
  ...
  modelSettings: {
    ...
    actions: {
      ...
      syncFromBifrost: 'Sync from Bifrost'
    },
    source: {
      remote: 'Remote',
    ...
    bifrostSync: {
      ...
      noBuiltin: 'No builtin models',
      noBifrost: 'No providers in Bifrost',
      builtinTitle: 'Builtin Models (DB)',
      bifrostTitle: 'Bifrost Providers',
      lastRefresh: 'Last refresh',
      models: 'models',
      staleCount: '{count} stale',
      staleWarning: 'Stale providers found: {providers}',
      deleteProvider: 'Delete',
      deleteSuccess: 'Deleted provider: {name}',
      deleteFailed: 'Delete failed',
      cleanAll: 'Clean All Stale',
      cleanSuccess: 'Stale providers cleaned',
      selectedCount: 'Selected {count} item(s)',
      selectAll: 'Select All',
      selectTypes: 'Select model types:',
      suggested: '✓',
      contextLength: 'Context: {length}',
      createSelected: 'Create Selected Models',
      noSelection: 'Please select at least one model',
      createSuccess: 'Successfully created {count} model(s)',
      createPartialFail: 'Created {success} model(s), {fail} failed',
      createFailed: 'Failed to create models',
  ...
  organization: {
    title: 'Knowledge Sharing Circles',
    subtitle: 'Create sharing circles to open your knowledge bases and agents to other teams',
