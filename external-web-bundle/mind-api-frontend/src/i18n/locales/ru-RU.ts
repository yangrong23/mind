export default {
  ...
  insights: {
    ...
    tabDailyReview: 'Ежедневный обзор',
    tabAIInsight: 'AI Инсайт',
    refresh: 'Сгенерировать заново',
    generating: 'AI генерирует…',
    dateRange: 'Диапазон дат',
    template: 'Шаблон',
    knowledgeBases: 'Базы знаний',
    allKnowledgeBases: 'Все базы знаний',
    generate: 'Создать инсайт',
    citationSources: 'Источники',
    wordCount: '{count} сл. · {refs} ссылок',
    noSources: 'Нет данных за этот период.',
...
/example\.(net|org)/`,
  ...
  workspace: {
    ...
    personal: 'Личное рабочее пространство',
    switchSuccess: 'Рабочее пространство переключено',
    join: 'Присоединиться',
    joinByCode: 'Присоединиться по коду',
    inviteCodePlaceholder: 'Введите код приглашения',
    joinSuccess: 'Вы успешно присоединились',
    joinFailed: 'Ошибка, проверьте код приглашения',
    teamLabel: 'Команда',
  },
  system: {
