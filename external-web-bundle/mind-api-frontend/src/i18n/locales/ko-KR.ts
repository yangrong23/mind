export default {
  ...
  insights: {
    pageTitle: "AI 인사이트",
    tabDailyReview: "일일 리뷰",
    tabAIInsight: "AI 인사이트",
    refresh: "재생성",
    generating: "AI가 생성 중…",
    dateRange: "날짜 범위",
    template: "템플릿",
    knowledgeBases: "지식베이스",
    allKnowledgeBases: "전체 지식베이스",
    generate: "인사이트 생성",
    citationSources: "인용 출처",
    wordCount: "{count}자 · {refs}개 인용",
    noSources: "해당 기간에 사용 가능한 콘텐츠가 없습니다.",
    errorRetry: "다시 시도",
  ...
  workspace: {
    ...
    switch: '워크스페이스 전환',
    personal: '개인 워크스페이스',
    switchSuccess: '워크스페이스가 전환되었습니다',
    join: '워크스페이스 참여',
    joinByCode: '초대 코드로 참여',
    inviteCodePlaceholder: '초대 코드를 입력하세요',
    joinSuccess: '워크스페이스에 성공적으로 참여했습니다',
    joinFailed: '참여 실패, 초대 코드를 확인하세요',
    teamLabel: '팀',
  },
  system: {
    title: "시스템 정보",
