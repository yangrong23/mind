          ...
          return (
            <button
              ...
              className={cn(
                ...
                active
                  ? "border-teal-200 bg-gradient-to-br from-teal-50/95 to-violet-50/75"
    ...
    <WebSettingsSubpage title="Cloud sync" onBack={onBack}>
      <div className="mx-auto max-w-[720px] px-10 py-8">
        <div className="flex flex-col items-center text-center">
          <div className="mb-6 flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-teal-50 to-violet-50">
      ...
      <div className="mx-auto max-w-[720px] space-y-4 px-10 py-6">
        <div
          className={cn(
            ...
            connected
              ? "border-teal-200/80 bg-gradient-to-br from-teal-50/80 to-violet-50/50"
