  ...
  return (
    <WebPageCanvas>
      <div className="mx-auto max-w-[1200px] p-6 lg:p-8">
        ...
        <div className="overflow-hidden rounded-2xl bg-gradient-to-r from-violet-600 via-indigo-600 to-teal-500 p-6 text-white shadow-xl shadow-violet-900/20 lg:p-8">
