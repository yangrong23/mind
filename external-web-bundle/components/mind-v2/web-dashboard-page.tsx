...
const quickActions = [
  { label: "New Note", icon: FileText, bg: "from-violet-500 to-purple-500" },
    ...
    <WebPageCanvas>
      <div className="mx-auto flex h-full min-h-0 max-w-[1400px] gap-6 p-6 lg:p-8">
        ...
        <aside className="hidden w-[min(300px,28%)] shrink-0 lg:block">
          ...
          <button
            type="button"
            className="mt-4 flex h-12 w-12 items-center justify-center self-end rounded-full bg-gradient-to-r from-violet-600 to-teal-500 text-white shadow-lg shadow-violet-500/30"
            aria-label="Create"
