export default {
  ...
  insights: {
    ...
    wordCount: "{count} 字 · {refs} 条引用",
    noSources: "当前时间范围内没有可用内容，请尝试扩大时间范围或添加知识库。",
    errorRetry: "重试",
    loadFailed: "加载失败，请稍后重试",
  },
  notes: {
    title: "笔记",
    subtitle: "你的第二大脑——快速记录、整理、回顾",
    create: "新建笔记",
    untitled: "无标题笔记",
    ...
    saveFailed: "保存失败",
    loadFailed: "加载笔记列表失败",
    loadContentFailed: "加载笔记内容失败",
    createFailed: "创建笔记失败",
    renameFailed: "重命名失败",
    placeholder: {
      title: "选择一篇笔记开始阅读",
      hint: "或者点击右上角创建一篇新的笔记。",
    },
    editor: {
      placeholder: "在此处开始书写……支持 Markdown",
    },
    empty: {
      title: "还没有笔记",
      hint: "点击右上方的「新建笔记」开始第一篇。",
    },
    delete: {
      title: "删除笔记",
      body: "确定要删除「{name}」吗？删除后无法恢复。",
      success: "已删除",
      failed: "删除失败",
    },
  },
  recordings: {
    title: "录音",
    subtitle: "捕捉灵感与会议——上传后由 AI 转写为笔记",
    create: "上传录音",
    listEmpty: "还没有录音",
    listEmptyHint: "点击右上方上传你的第一段语音。",
    uploadHint: "支持 mp3 / m4a / wav，单文件 ≤ 50MB",
    uploadFailed: "上传失败",
    uploadSuccess: "上传成功",
    deleteFailed: "删除失败",
  ...
  landing: {
    eyebrow: "Mind · 你的智能知识工作台",
    headline: "把零散信息变成你思考的延伸",
    subheadline: "语音捕捉 · 知识图谱 · 智能体协作——让你的研究、笔记与对话融为一体。",
    ctaPrimary: "开始使用",
    ctaSecondary: "了解更多",
    features: {
      voiceTitle: "语音捕捉",
      voiceDesc: "随时录制想法，自动转写并归入你的知识库。",
      graphTitle: "知识图谱",
      graphDesc: "自动连接概念，发现你思维中的隐藏关系。",
      agentTitle: "智能体协作",
      agentDesc: "由 AI 帮你检索、起草、推理，对话式完成工作。",
      multiTitle: "多端同步",
      multiDesc: "桌面、Web 一键同步，离开屏幕也不丢失上下文。",
    },
    ...
    heroSidebar3: "我的资料库",
    heroSidebar4: "项目",
    socialProof: "加入用户行列，用 Mind 更聪明地思考",
    // Capture section
    captureTitle: "轻松捕获知识碎片",
    captureSubtitle: "从网页、文件、移动端导入——或订阅广场精选资料库。内容深度解析，快速开始。",
    captureFeature0Title: "网页剪藏",
    captureFeature0Desc: "一键保存网页和文章到你的资料库。",
    captureFeature1Title: "文件上传与解析",
    captureFeature1Desc: "PDF、Word、PPT、Excel 等——智能解析用于搜索和问答。",
    captureFeature2Title: "任意设备捕获",
    captureFeature2Desc: "手机或网页记录笔记、语音、照片——同账号，同资料库。",
    captureTableTitle: "我的知识库",
    captureCol0: "标题",
    captureCol1: "来源",
    captureCol2: "类型",
    captureCol3: "添加时间",
    captureRow0_0: "产品周报.pdf",
    captureRow0_1: "上传",
    captureRow0_2: "PDF",
    captureRow0_3: "5月12日",
    captureRow1_0: "行业资料库",
    ...
    captureRow2_3: "5月9日",
    // Q&A section
    qaTitle: "从知识库精准问答——Mind 给出结果",
    qaSubtitle: "答案基于你信任的来源，附带原文引用。",
    qaBullet0: "理解上下文中的问题",
    qaBullet1: "引用来源——可靠且可追溯",
    qaBullet2: "多轮对话和复杂任务",
    qaQuestion: "我们的核心目标用户是谁？",
    qaAnswer: "根据你资料库中的用户研究和访谈笔记，核心细分包括：",
    qaPoint0: "管理大量文档的知识工作者",
    qaPoint1: "需要统一真相来源的团队",
    qaPoint2: "构建个人知识系统的学习者",
    qaCite0: "用户研究报告.pdf",
    qaCite1: "访谈笔记",
    // Notes section
    notesTitle: "AI 笔记——懂你的创作伙伴",
    notesSubtitle: "全程 AI 辅助写作：捕捉想法、润色表达、将完成的笔记归入资料库。",
    notesDocTitle: "产品需求",
    notesDocBody: "本次发布聚焦基于资料库的问答和内容工厂。移动端和网页端应共享同一资料库和 Mind 体验…",
    notesMenu0: "继续写作",
    notesMenu1: "润色",
    notesMenu2: "总结",
    notesMenu3: "翻译",
    notesFeature0Title: "智能补全",
    notesFeature0Desc: "根据笔记上下文继续和补全。",
    notesFeature1Title: "格式与清晰度",
    notesFeature1Desc: "一步改善结构和可读性。",
    notesFeature2Title: "翻译与润色",
    notesFeature2Desc: "多语言草稿，语气由你控制。",
    // Collaboration section
    collabSharedTitle: "我们的共享大脑",
    collabBullet0: "实时协作——所有人保持同步",
    collabBullet1: "评论和讨论改进知识",
    collabBullet2: "版本历史让重要变更可追溯",
    collabDocTitle: "Q2 产品计划",
    collabDocSnippet: "本周共识：优先资料库问答和内容工厂；Mind 和 Studio 共享相同来源…",
    collabComment: "@团队 已更新资料库中的研究摘要。",
    collabPermissionsTitle: "灵活权限",
    permPrivateTitle: "私有",
    permPrivateDesc: "个人——仅你可见",
    permTeamTitle: "团队",
    permTeamDesc: "与你的小组共享",
    permPublicTitle: "公开",
    permPublicDesc: "在广场发布或订阅",
    // Resources section
    resourcesTitle: "访问海量专业知识——即用",
    resourcesSubtitle: "在资料库广场订阅——无需从零开始。",
    resource0Stat: "1,000+",
    resource0Label: "资料库模板",
    resource1Stat: "5,000+",
    resource1Label: "行业报告",
    ...
    resource5Label: "社区",
    // Footer CTA
    footerCtaTitle: "在浏览器中开始你的知识之旅",
    footerCtaSubtitle: "打开网页应用——在桌面端用同一资料库捕获、整理、向 Mind 提问。",
    footerCtaBtn: "立即试用网页版",
    footerCopyright: "© Mind. 保留所有权利。",
    footerLink0: "关于",
    footerLink1: "条款",
    footerLink2: "帮助",
    footerLink3: "联系",
  ...
  mindarAuth: {
    joinTitle: "加入 Mindar",
    joinSubtitle: "登录以在 Web 端同步笔记、知识库与 Mind Copilot。",
    ...
    legalAnd: "与",
    privacy: "隐私政策",
    signInSubtitle: "为以下账号输入密码：",
    back: "返回",
    home: "首页",
    backToApp: "进入应用",
    illustrationTitle: "Mind Copilot，",
    illustrationTitle2: "智慧随库生长",
    illustrationTagline: "采集、整理、消化、分享与交付 — 让每一片知识都产生价值。",
    hasAccount: "已有账号？",
    noAccount: "首次使用 Mindar？",
    signInWithEmail: "邮箱登录",
    createAccount: "注册账号",
    socialDemo: "使用 {provider} 登录需要在服务端配置 OIDC。",
    googleOidcUnavailable:
      "当前服务器未启用 Google 登录，请联系管理员配置 OIDC，或使用邮箱登录。",
  },
  authStore: {
    errors: {
  ...
  workspace: {
    ...
    switch: "切换工作空间",
    personal: "个人工作空间",
    switchSuccess: "工作空间切换成功",
    join: "加入工作空间",
    joinByCode: "通过邀请码加入",
    inviteCodePlaceholder: "请输入邀请码",
    joinSuccess: "已成功加入工作空间",
    joinFailed: "加入失败，请检查邀请码是否有效",
    teamLabel: "团队",
    teamSettings: "团队设置",
    inviteCode: "邀请码",
    noInviteCode: "尚未生成邀请码",
    generateCode: "生成邀请码",
  ...
  modelSettings: {
    ...
    bifrostSync: {
      ...
      loadError: "加载失败",
      noBuiltin: "暂无内置模型",
      noBifrost: "Bifrost 中无 provider",
      builtinTitle: "内置模型 (DB)",
      bifrostTitle: "Bifrost Providers",
      lastRefresh: "最后刷新",
      models: "个模型",
      staleCount: "{count} 个过期",
      staleWarning: "发现过期 provider: {providers}",
      deleteProvider: "删除",
      deleteSuccess: "已删除 provider: {name}",
      deleteFailed: "删除失败",
      cleanAll: "清理全部过期",
      cleanSuccess: "过期 provider 已清理",
      selectedCount: "已选择 {count} 项",
      createSelected: "创建选中的模型",
      noSelection: "请至少选择一个模型",
      createSuccess: "成功创建 {count} 个模型",
      createFailed: "创建模型失败",
      syncSuccess: "模型同步成功",
      builtin: "全局内置"
    }
  ...
  organization: {
    title: "知识共享圈",
    subtitle: "创建知识共享圈，向其他团队开放你的知识库与智能体",
    createOrg: "创建空间",
    createOrgShort: "新建",
    joinOrg: "加入空间",
    joinOrgShort: "加入",
