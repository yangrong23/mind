...
.rich-input-container {
  ...
  box-shadow: 0 10px 36px -14px rgba(0, 0, 0, 0.07), 0 2px 10px -4px rgba(0, 0, 0, 0.04);
  transition: border-color 0.2s ease, box-shadow 0.3s ease;

  &:focus-within {
    border-color: rgba(14, 165, 233, 0.4);
    box-shadow: 0 14px 44px -16px rgba(14, 165, 233, 0.15), 0 4px 14px -6px rgba(0, 0, 0, 0.05);
  }
}
...
.selected-tags-inline {
  ...
  border-radius: 19px 19px 0 0; /* 与 .rich-input-container 内缘上边圆角一致（20px - 1px 边框） */
}
...
.mention-chip--kb .mention-chip__icon-wrap {
  ...
  color: var(--td-brand-color, #0ea5e9);
}
