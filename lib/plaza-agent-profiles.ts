...
const PLAZA_AGENT_BY_KB: Record<number, Partial<PublicKbSettings>> = {
  ...
  113: {
    boundAgentId: 206,
    boundAgentName: "Team Knowledge",
    displayName: "Team Knowledge",
    tagline: "Production LLM notes — RAG, evals, and cost control from one thread.",
    capabilities: ["Architecture Q&A", "Eval checklists", "Cost tradeoffs", "Runbook drafts"],
    exampleQuestions: [
    ...
    skills: [
      { id: "tk1", label: "Architecture Q&A", instruction: "Answer system design questions with citations from team playbooks." },
      { id: "tk2", label: "Eval checklists", instruction: "Turn eval notes into actionable checklists grounded in library sources." },
      { id: "tk3", label: "Cost tradeoffs", instruction: "Compare inference and infra cost strategies mentioned in sources." },
      { id: "tk4", label: "Runbook drafts", instruction: "Draft operational runbooks from incident and release logs in this library." },
    ],
