...
const tabs = [
  ...
  { id: "knowledge" as TabType, label: "Library", icon: Layers },
  { id: "agent" as TabType, label: "Agent", icon: Sparkles },
...
export function BottomNav({ activeTab, onTabChange }: BottomNavProps) {
  return (
    <nav
      className={cn(
        "flex w-full items-center justify-around border-t border-stone-200/85 pt-1.5",
