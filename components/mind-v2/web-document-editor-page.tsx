    ...
    <div className="flex h-full min-h-0 bg-[#f8f9fc]">
      ...
      <div className="flex min-w-0 flex-1 flex-col bg-white">
        <div className="flex shrink-0 items-center gap-2 border-b border-stone-100 px-4 py-2">
          ...
          <button
            type="button"
            className="ml-2 inline-flex items-center gap-1 rounded-lg bg-sky-50 px-2.5 py-1 text-[13px] font-semibold text-sky-700"
          >
      ...
      <aside className="flex w-[280px] shrink-0 flex-col border-l border-stone-200/80 bg-white">
        ...
        <div className="border-t border-stone-100 p-4">
          ...
          <div className="mt-2 rounded-xl border border-sky-100 bg-sky-50/50 p-3 text-[13px] text-zinc-700">
            Add a single sentence that states the decision this section drives.
          </div>
          <button
            type="button"
            onClick={() => toast.success("Applied")}
            className="mt-2 w-full rounded-lg bg-sky-600 py-2 text-[13px] font-semibold text-white"
          >
            Apply
          </button>
        </div>
