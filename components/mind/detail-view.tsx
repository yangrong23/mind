...
const transcriptSegments = [
  {
    time: "00:00:00",
    text: "Next, we walk through how to use Mind devices—from recording and marks to smart summaries, AI Q&A, and export—so you can get more done. With Mind Pro, Mind Pin S, or Mindar Note, press and hold the device button for high-quality recording.",
  },
  {
    time: "00:00:35",
        ...
        {activeTab === "source" ? (
          ...
          <div className="px-4">
            ...
            <div className="space-y-6 pb-6">
              ...
              <p className="text-base text-zinc-700 leading-relaxed">
                On Mind Pro, Mind Pin S, or Mindar Note, press and hold the device button for high-quality capture.
              </p>
